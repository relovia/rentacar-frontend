...
export class ModelControllerService implements ModelControllerServiceInterface {
  ...
  ): Observable<HttpResponse<CreateModelResponse>>;
  public add1(
    requestParameters: Add1RequestParams,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<CreateModelResponse>>;
  public add1(
    requestParameters: Add1RequestParams,
    observe: any = 'body',
    ...
    if (createModelRequest === null || createModelRequest === undefined) {
      throw new Error(
        'Required parameter createModelRequest was null or undefined when calling add1.'
      );
    }
    ...
    return this.httpClient.request<CreateModelResponse>(
      'post',
  ...
  public delete1(
    ...
    let localVarPath = `/api/models/delete/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
  ...
  ): Observable<Array<GetAllModelResponse>>;
  public getAll1(
    observe?: 'response',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpResponse<Array<GetAllModelResponse>>>;
  public getAll1(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<Array<GetAllModelResponse>>>;
  public getAll1(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: {
    ...
    return this.httpClient.request<Array<GetAllModelResponse>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  ): Observable<HttpResponse<GetModelByIdResponse>>;
  public getModelById(
    requestParameters: GetModelByIdRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<GetModelByIdResponse>>;
  public getModelById(
    requestParameters: GetModelByIdRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    let localVarPath = `/api/models/get/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
    ...
    return this.httpClient.request<GetModelByIdResponse>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  ): Observable<HttpResponse<UpdateModelResponse>>;
  public update1(
    requestParameters: Update1RequestParams,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<UpdateModelResponse>>;
  public update1(
    requestParameters: Update1RequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (updateModelRequest === null || updateModelRequest === undefined) {
      throw new Error(
        'Required parameter updateModelRequest was null or undefined when calling update1.'
      );
    }
    ...
    return this.httpClient.request<UpdateModelResponse>(
      'put',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
