...
export class BrandControllerService implements BrandControllerServiceInterface {
   ...
   */
  public add4(
    requestParameters: Add4RequestParams,
    observe?: 'body',
  ...
  ): Observable<HttpResponse<CreateBrandResponse>>;
  public add4(
    requestParameters: Add4RequestParams,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<CreateBrandResponse>>;
  public add4(
    requestParameters: Add4RequestParams,
    observe: any = 'body',
    ...
    if (createBrandRequest === null || createBrandRequest === undefined) {
      throw new Error(
        'Required parameter createBrandRequest was null or undefined when calling add4.'
      );
    }
    ...
    return this.httpClient.request<CreateBrandResponse>(
      'post',
  ...
  public delete4(
    ...
    let localVarPath = `/api/brands/delete/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
  ...
  ): Observable<HttpResponse<Array<GetAllBrandResponse>>>;
  public getAll4(
    observe?: 'events',
    reportProgress?: boolean,
    options?: {
  ...
  ): Observable<HttpEvent<Array<GetAllBrandResponse>>>;
  public getAll4(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: {
    ...
    return this.httpClient.request<Array<GetAllBrandResponse>>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  ): Observable<HttpResponse<GetBrandByIdResponse>>;
  public getBrandById(
    requestParameters: GetBrandByIdRequestParams,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<GetBrandByIdResponse>>;
  public getBrandById(
    requestParameters: GetBrandByIdRequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    let localVarPath = `/api/brands/get/${this.configuration.encodeParam({
      name: 'id',
      value: id,
      in: 'path',
      style: 'simple',
    ...
    return this.httpClient.request<GetBrandByIdResponse>(
      'get',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
  ...
  ): Observable<HttpResponse<UpdateBrandResponse>>;
  public update4(
    requestParameters: Update4RequestParams,
    observe?: 'events',
    reportProgress?: boolean,
  ...
  ): Observable<HttpEvent<UpdateBrandResponse>>;
  public update4(
    requestParameters: Update4RequestParams,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (updateBrandRequest === null || updateBrandRequest === undefined) {
      throw new Error(
        'Required parameter updateBrandRequest was null or undefined when calling update4.'
      );
    }
    ...
    return this.httpClient.request<UpdateBrandResponse>(
      'put',
      `${this.configuration.basePath}${localVarPath}`,
      {
        context: localVarHttpContext,
