...
export class CarControllerService implements CarControllerServiceInterface {
  ...
  public add3(
    ...
    if (createCarRequest === null || createCarRequest === undefined) {
      throw new Error(
        'Required parameter createCarRequest was null or undefined when calling add3.'
      );
    }
  ...
  public update3(
    ...
    if (updateCarRequest === null || updateCarRequest === undefined) {
      throw new Error(
        'Required parameter updateCarRequest was null or undefined when calling update3.'
      );
    }
